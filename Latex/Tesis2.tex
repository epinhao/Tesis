...
Para modelar la dinámica del libro de posturas limitado se considera el modelo propuesto en \cite{Cont2010}. Este modelo tiene varias bondades que permiten la utilización de las herramientas matemáticas presentadas en el apéndice para realizar el cálculo de las probabilidades de algunos eventos. El modelo considera que las llegadas de las posturas siguen un proceso Poisson, es decir, que son completamente aleatorias y que las posturas tiene un volumen estandarizado o único.\\
