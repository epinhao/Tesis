...
Ahora iterando en la expresión que se obtuvo previamente para $\hat{f}_{i,i-1}(s)$, se obtiene:
...
Finalmente, más adelante será de interés para el análisis encontrar la distribución del tiempo del primer paso del estado $i$ al estado 0, definido como $\sigma_{i}$, cuya transformada de Laplace se calcula por \ref{eq:laplacesum} de esta forma:
\begin{equation}
