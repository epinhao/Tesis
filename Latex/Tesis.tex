...
En los mercados regidos por formadores de mercado, éstos centralizan las órdenes proveyendo liquidez al fijar una postura de compra y una de venta; por ejemplo el especialista en el NYSE. En los mercados regidos por órdenes, las posturas de todos los participantes se agregan en lo que se conoce como el libro de posturas. Los mercados regidos por órdenes tienen como ventaja la transparencia, ya que todos los participantes conocen las posturas de los demás. Existen algunos mercados híbridos donde los formadores de mercado interactúan en el libro de posturas. La Bolsa Mexicana de Valores y NASDAQ son ejemplos de mercados híbridos.\\

El estudio de la microestuctura del mercado es de utilidad ya que permite identificar patrones dentro del mismo, los cuales pueden ser utilizados para la predicción y también para identificar comportamientos fraudulentos. Los comportamientos fraudulentos son de gran interés para los reguladores del mercado, bases de datos parecidas han sido utilizadas para identificar casos en el que varios participantes del mercado han conspirado para manipular precios.
\\

Con el objetivo de estudiar el comportamiento de la Bolsa Mexicana de Valores, se obtuvo una base de datos con todas las posturas del libro de órdenes en un periodo determinado. En este trabajo, se describirá en primer lugar esta base datos; después se explicará la forma en que se reconstruyó el libro de posturas para poder llevar a cabo el análisis. Los resultados obtenidos tras la reconstrucción se compararán con los de otros estudios similares para otros mercados. Finalmente se describirá un modelo del libro de posturas y un método basado en la transformación inversa de Laplace para llevar a cabo la predicción del movimiento en el precio de una emisora.
...
Con el botón de ``Siguiente'' se van procesando una a una las entradas del registro. En el caso de una postura de compra, se trata de buscar en primer lugar, una postura en los corros de venta para perfeccionarla, si no existe, ésta se registra en los corros de compra, los cuales están ordenados de mayor a menor precio. Esto se hace de igual forma para las posturas de venta, éstas están ordenadas también de mayor a menor precio, de tal forma, que la postura que se encuentra en la parte inferior de los corros de venta y la que se encuentra en la parte más alta de los corros de compra son las puntas. La interfaz también permite cancelar una postura de compra o una de venta al seleccionarla y oprimir el botón correspondiente con el objeto de poder depurar errores en el funcionamiento del algoritmo.\\

Como se mencionó antes, los hechos se registran con la clave AH; éstos se mantienen en la ventana de ``Hechos Registrados por la BMV''. Cuando el algoritmo desarrollado perfecciona un hecho, éste se registra en la venta de ``Hechos Reportados por el Algoritmo''. Finalmente, se encuentran las cancelaciones y las modificaciones, para éstas es necesario localizar el folio correspondiente en los corros de compra o venta para hacer la cancelación o modificación correspondiente. Con el fin de poder analizar el registro con mayor rapidez, se implementó el botón de ``Play'', el cual permite avanzar 100 entradas del registro.
...
Después de reconstruir el libro de posturas de la Bolsa Mexicana de Valores, se compararon los resultados con los que se han realizado para otros mercados. Para algunas de las variables los resultados fueron similares a los encontrados en otros mercados; por ejemplo los precios siguen una ley de potencias.
