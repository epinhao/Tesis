...
El estudio de la microestuctura del mercado es de utilidad ya que permite identificar patrones dentro del mismo, los cuales pueden ser utilizados para la predicción y también para identificar comportamientos fraudulentos.\\

Con el objetivo de estudiar el comportamiento de la Bolsa Mexicana de Valores, se obtuvo una base de datos con todas las posturas del libro de órdenes en un periodo determinado. En primer lugar se describirá esta base datos; después se explicará la forma en que se reconstruyó el libro de postura para poder llevar a cabo el análisis. Los resultados obtenidos tras la reconstrucción se compararán con los de otros estudios similares para otros mercados. Finalmente se describirá un modelo de el libro de posturas y método basado en la transformación inversa de Laplace para llevar a cabo la predicción del movimiento en el precio de una emisora.
